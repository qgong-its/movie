...
export function renderMovieCard(movies, containerId) {
  ...
  const movieCard = movies
    .map(
      (movie) => `
        <article class="movie-card group relative flex flex-col rounded-xl border border-[#334155] bg-[#1E293B] p-3 shadow-md transition-all hover:-translate-y-1 hover:border-[#FACC15]/50" data-id="${movie.id}">
